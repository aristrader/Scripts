...
input_file = '/Users/swapnilagarwal/Visual_Studio_Projects/Excel/SUNNEY.BSC2.UNI.xls'  # Replace with your actual file path
output_file = '/Users/swapnilagarwal/Visual_Studio_Projects/Excel/resultstemp/SUNNEY.BSC2.UNI.xls'  # Replace with your desired output file path
...
for index, row in df.iterrows():
    transformed_row = [
        ...
        [
            ...
            '', '',row.iloc[columns['Mother_Name']], 'I (B) ENGLISH LANGUAGE & IND.CULTURE', '', '', '', '', '', '', '', ''
        ],
        # Row 4
        [
            # _, _, _, Course3, main,
        ...
        [
            # _, _, _, _, 'TOTAL'
            '', 'AGPA = CREDIT POINTS/MAX CREDIT', '', '                                                          TOTAL:', '',
        ...
        [
            ...
            # _, _, _
            '                                                            TOTAL.AGPA:  ' + str(row.iloc[columns['TOTAL_AGPA']]), '', '', '', '', #'PER.:  ' + str(row.iloc[columns['Percentage']]), 
            '', 'RESULT:' + row.iloc[columns['Result']],
