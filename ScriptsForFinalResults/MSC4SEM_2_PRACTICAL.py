...
input_file = '/Users/swapnilagarwal/Visual_Studio_Projects/Excel/SUNNY.MSC4SEM.ZOOLOGY.2024.xls'  # Replace with your actual file path
output_file = '/Users/swapnilagarwal/Visual_Studio_Projects/Excel/RESULT_MSC4SEM_ZOOLOGY_RESULTS.xls'  # Replace with your desired output file path
...
columns = {
    ...
    'Practical_Suffix': 37,
    'Practical_1': 38,
    'Practical_1_Suffix': 39,
    'Practical_2': 40,
    'Practical_2_Suffix': 41,
    'Therory_Total': 42,
    'Practical_Total': 43,
    'SEM_1': 44,
    'SEM_2': 45,
...
for index, row in df.iterrows():
    ...
    transformed_row = [
        ...
        [
            ...
            '', 
            '    THEORY MARKS:' + str(row.iloc[columns['Therory_Total']]) + '/500',
            '    PRACTICAL MARKS:' + str(row.iloc[columns['Practical_Total']]) + '/200', 
            '  TOTAL MARKS:' + str(row.iloc[columns['Therory_Total']] + row.iloc[columns['Practical_Total']]) + '/700', 
            '', '', '', '', ''
        ],
        # Row 11
        [
