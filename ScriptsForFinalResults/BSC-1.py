...
input_file = '/Users/swapnilagarwal/Visual_Studio_Projects/Excel/SUNNEY.BSC1.UNI.xls'  # Replace with your actual file path
output_file = '/Users/swapnilagarwal/Visual_Studio_Projects/Excel/resultstemp/SUNNEY.BSC1.UNI.xls'  # Replace with your desired output file path
...
for index, row in df.iterrows():
    transformed_row = [
        ...
        [
            ...
            '', '',row.iloc[columns['Mother_Name']], 'I (B) ENGLISH LANGUAGE & INDIAN', '', '', '', '', '', '', '', ''
        ],
        # Row 4
        [
            # _, _, _, Course3, main,
