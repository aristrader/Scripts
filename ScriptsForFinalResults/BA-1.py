...
input_file = '/Users/swapnilagarwal/Desktop/results-input.xls'  # Replace with your actual file path
output_file = '/Users/swapnilagarwal/Desktop/results-output.xls'  # Replace with your desired output file path
...
columns = {
    ...
    'VOC_Grade_Letter': 93,
    'VOC_Grade_Point': 94,
    'VOC_Earned_Credit': 95,
    'VOC_Credit_Points': 96,
    'VOC_Practical': 15,
    ...
    'Project/Internship_Practical_Main_marks': 97,
...
for index, row in df.iterrows():
    transformed_row = [
        ...
        [
            ...
            '', '', '', row.iloc[columns['Major_1_Subject']], row.iloc[columns['Major_1_Main_Marks']],
            #  cce, obt,
        ...
        # Row 7
        [
            # _, _, _, Major_1_practical, main,
            '', '', '', row.iloc[columns['Major_1_Practical']], '',
            #  cce, obt,
        ...
        # Row 9
        [
            # _, _, _, Major_2_practical, main,
            '', '', '', row.iloc[columns['Major_2_Practical']], '',
            #  cce, obt,
        ...
        [
            ...
            '', '', '', row.iloc[columns['Minor_Practical']], '',
            #  cce, obt,
        ...
        # Row 13
        [
            # _, _, _, Open_practical, main,
            '', '', '', row.iloc[columns['Open_Practical']], '',
            #  cce, obt,
        ...
        [
            ...
            #  cce, obt,
            row.iloc[columns['VOC_CCE_Marks']], row.iloc[columns['VOC_Total_Marks']],
            # max_credits, letter_grade,
        ...
        [
            ...
            '', '', '', row.iloc[columns['VOC_Practical']], '',
            #  cce, obt,
        ...
        [
            ...
            '', 'AGPA = CREDIT POINTS/MAX CREDIT', '', '', 'AGPA: ' + str(row.iloc[columns['AGPA']]),
            # _, _, _
            '', '', '', '',
            # _, _, _, _
            '', '', ''
